...
async function getSocket(url) {
    ...
    const { schedule } = (0, createBatchScheduler_js_1.createBatchScheduler)({
        ...
        fn: async () => {
            ...
            if (isomorphic_ws_1.WebSocket.default
                ?.constructor)
                PatchedWebSocket = isomorphic_ws_1.WebSocket.default;
            else
                PatchedWebSocket = isomorphic_ws_1.WebSocket.WebSocket;
            ...
            if (webSocket.readyState === isomorphic_ws_1.WebSocket.CONNECTING) {
